...
export default function PsychologistRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Your psychologist application has been submitted. Please wait for admin approval."
      );
    ...
    <div className="psychologist-page">
      ...
      <div className="psychologist-container">
        ...
        <div className="psychologist-header">
          ...
          <h1 className="psychologist-title">
            Join Swastprova as a Psychologist
          </h1>

          <p className="psychologist-description">
            Help people improve their mental well-being by
        ...
        <div className="psychologist-card">
          ...
          <div className="psychologist-top-line"></div>

          <div className="psychologist-card-content">
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-section-header">
                  ...
                  <div>
                    ...
                    <p>
                      Tell users about your professional approach
                    </p>
                  </div>
                ...
                >
                  ...
                  <textarea
                    name="bio"
                    placeholder="Tell us about your experience, approach and how you help people..."
                    value={form.bio}
                    onChange={handleChange}
                    rows={5}
              ...
              <div className="review-box">
                ...
                <div>
                  ...
                  <p>
                    ...
                    Swastprova admin team. Your profile will
                    become visible to users only after approval.
                  </p>
              ...
              >
                ...
                {loading ? (
                  ...
                  "Submit Psychologist Application →"
                )}
